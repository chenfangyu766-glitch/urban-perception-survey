...
LANG_DICT = {
    "English": {
        ...
        "privacy_btn": "📄 View Full Information Sheet",
        "privacy_content": """
            ### INFORMATION SHEET & INFORMED CONSENT
            **1. Project Lead**: Prof. Elisa Conticelli (University of Bologna).
            **2. Objectives**: To understand how people evaluate the quality (pleasantness, safety) of streets in Italian historic centres.
            **3. Participation**: A short online survey (~5 min). You will compare pairs of images from Florence, Ravenna, Bologna, and Ferrara.
            ...
            **7. Anonymity**: Natively anonymous collection. No IP or identifying data recorded.
    ...
    "Italiano": {
        ...
        "privacy_content": """
            ...
            **2. Obiettivi**: Capire come le persone valutano la qualità (piacevolezza, sicurezza) delle strade nei centri storici italiani.
            **3. Partecipazione**: Questionario online (circa 5 min). Confronto di immagini di Firenze, Ravenna, Bologna e Ferrara.
            **4. Benefici e rischi**: Partecipazione volontaria e gratuita. Non comporta rischi o disagi.
    ...
    "中文": {
        ...
        "privacy_content": """
            ...
            **2. 研究目标**：了解公众如何评价意大利历史中心街道的质量（如宜人性、安全性等）。
...
def show_privacy_modal(content):
    st.markdown(content)
    if st.button("Close / Chiudi / 关闭", use_container_width=True):
        st.rerun()
